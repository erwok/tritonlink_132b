...
<head>
<meta charset="UTF-8">
<title>Grade Distributions Option Selection Page (ms5)</title>
</head>
<body>
<%-- Set the scripting language Java and --%>
<%@ page language="java" import="java.sql.*" %>
	<h1>Grade Distributions Option Selection Page with Materialized Views (Milestone 5)</h1>
	<%
	try {
	    // Load driver
	...
	<br>
	<h4>3.a.2 Counts of Grades based on Course ID, Professor, and Quarter</h4>
	<table>
	    <tr>
	        <th>Course Number</th>
	        <th>Professor</th>
	    ...
	    <tr>
	        <form action="ms5_query1.jsp" method="get">
	            <%
	...
	<br>
	<h4>3.a.3 Counts of Grades based on Course ID and Professor</h4>
	<table>
	    <tr>
	        <th>Course Number</th>
	        <th>Professor</th>
	    ...
	    <tr>
	        <form action="ms5_query2.jsp" method="get">
	            <%
	            rs = stmt.executeQuery(get_courses);
	            %>
	            <td><select name="courseNum">
