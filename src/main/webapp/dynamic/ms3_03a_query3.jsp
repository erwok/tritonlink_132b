...
%>
<title><%= courseNum %>'s Grade Counts</title>
</head>
<body>
<%-- Set the scripting language Java and --%>
<%@ page language="java" import="java.sql.*, java.util.*" %>

<h2><%= courseNum %>'s Cumulative Grade Counts</h2>
	...
	<%
		String get_grades_for_course = 
			"SELECT pasttake_grade AS grade FROM pasttake WHERE cr_courseNumber = '" + courseNum + "'";
		rs = stmt.executeQuery(get_grades_for_course);
