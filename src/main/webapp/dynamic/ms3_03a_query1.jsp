...
%>
<title><%= courseNum %> taught by <%= professor %> in <%= quarter + " " + year %> Grade Counts</title>
</head>
<body>
<%-- Set the scripting language Java and --%>
<%@ page language="java" import="java.sql.*, java.util.*" %>

<h2><%= courseNum %> taught by <%= professor %> in <%= quarter + " " + year %> Cumulative Grade Counts</h2>
