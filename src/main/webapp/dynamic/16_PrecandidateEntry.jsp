...
<head>
<meta charset="UTF-8">
<title>Precandidate Entry Page</title>
</head>
<body>
			<%-- Set the scripting language Java and --%>
			<%@ page language="java" import="java.sql.*" %>
			<b>Precandidate Entry Page</b>
			...
			<table>
				...
				<%
					...
					if (action != null && action.equals("insert")) {
					    ...
					    ("INSERT INTO Precandidate VALUES (?, ?, ?, ?, ?, ?, ?)"));
				...
				if (action != null && action.equals("update")) {
				    ...
				    PreparedStatement pstatement = connection.prepareStatement(
				    	"UPDATE Precandidate SET st_SSN = ?, st_enrollmentStatus = ?, st_residential = ?,\n"+
				    ...
				    pstatement.setString(7, request.getParameter("st_ID"));
				...
				<%
					...
					String GET_Undergraduate_QUERY = "SELECT * FROM Precandidate";
					ResultSet rs = stmt.executeQuery(GET_Undergraduate_QUERY);
				%>
				
				<tr>
					<form action="16_PrecandidateEntry.jsp" method="get">
