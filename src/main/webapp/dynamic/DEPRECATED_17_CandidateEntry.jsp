			...
			<table>
				...
				<%
					...
					if (action != null && action.equals("insert")) {
					    ...
					    pstmt.setString(8, request.getParameter("advisor"));
				...
				if (action != null && action.equals("update")) {
				    ...
				    PreparedStatement pstatement = connection.prepareStatement(
				    	"UPDATE Candidate SET st_SSN = ?, st_enrollmentStatus = ?, st_residential = ?,\n"+
		    	        "st_firstName = ?, st_middleName = ?, st_lastName = ?, advisor = ? \n"+
				    	"WHERE st_ID = ? "
				    );
				    ...
				    pstatement.setString(7, request.getParameter("advisor"));
				...
				<%
					...
					String GET_Undergraduate_QUERY = "SELECT * FROM Candidate";
					ResultSet rs = stmt.executeQuery(GET_Undergraduate_QUERY);
				%>
				
				<tr>
					<form action="17_CandidateEntry.jsp" method="get">
				...
				rs = stmt.executeQuery(
					...
					"ORDER BY st_ID, st_SSN, st_enrollmentStatus, st_residential, st_firstName, st_middleName, st_lastName, advisor"
				);
