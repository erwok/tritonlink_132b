			...
			<table>
				...
				if (action != null && action.equals("update")) {
				    ...
				    PreparedStatement pstatement = connection.prepareStatement(
				    	"UPDATE Master SET st_SSN = ?, st_enrollmentStatus = ?, st_residential = ?,\n"+
				...
				<%
					...
					String GET_Undergraduate_QUERY = "SELECT * FROM Master";
					ResultSet rs = stmt.executeQuery(GET_Undergraduate_QUERY);
				%>
				
				<tr>
					<form action="15_MastersEntry.jsp" method="get">
