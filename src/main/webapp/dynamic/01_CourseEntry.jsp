...
<body>
			...
			CREATE TABLE Prerequisite (
				...
				prerequisiteCourseNumber VARCHAR(255) NOT NULL, 
			 	CONSTRAINT FK_PreCourse1 FOREIGN KEY (mainCourseNumber) REFERENCES Course(cr_courseNumber), 
				CONSTRAINT FK_PreCourse2 FOREIGN KEY (prerequisiteCourseNumber) REFERENCES Course(cr_courseNumber)
			);
			...
			CREATE TABLE Class (
				...
				CONSTRAINT pk_Class PRIMARY KEY(cl_title, cl_year, cl_quarter)
			);
